  ...
  hardware = {
    deviceTree = {
      ...
      overlays = [
        ...
        (./. + "/reTerminal-esp-contents/overlays/vc4-kms-v3d-pi4.dtbo")
        (./. + "/reTerminal-esp-contents/overlays/i2c3.dtbo")
        {
          name = "reTerminal-overlay";
          dtsText = ''
            /dts-v1/;
            /plugin/;
