{ config, ... }:
{
  ...
  koshos.home.honzakostejn.programs.helix.enable = false;
  koshos.home.honzakostejn.programs.nushell.enable = true;
  koshos.home.honzakostejn.programs.opencode.enable = false;
  koshos.home.honzakostejn.programs.starship.enable = false;
